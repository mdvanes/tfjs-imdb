...
# Based on https://github.com/tensorflow/tfjs-examples/blob/master/sentiment/serve.sh
...
node_modules/parcel-bundler/bin/cli.js serve index.html -d dist --no-hmr --public-url /
